...
def function3():
    ...
    x = a[np.logical_and(a%7==0, a%5==0)] #wrtie your code here
    return x
    """
    Expected Output:
...
def function4():
    ...
    return np.transpose((np.transpose(arr)[[1,0,2]])) #wrtie your code here
    """
    Expected Output:
          array([[1, 0, 2],
                [4, 3, 5],
...
def function5():
    ...
    z = np.zeros((4, 5), dtype = np.int32) #wrtie your code here
...
def function6():
    ...
    arr = np.array([0,0,0,0,10,0,0,20,0,0])#wrtie your code here
...
def function7():
    ...
    return np.zeros(x.size, dtype=x.dtype)#write your code here
...
def function8():
    ...
    x = (np.ones(10, dtype = np.uint32).reshape(2,5)) * 6 #write your code here
...
def function12():
    ...
    arr = np.array([1,2,3])
    ans = np.concatenate((np.repeat(arr,3), np.tile(arr,3)), axis = 0) #write your code here 
...
def function13():
    ...
    ans = arr[np.logical_and(arr > 5, arr < 10)] #write your code here 
...
def function15():
    ...
    ans = np.sort(arr.view('i4,i4,i4'), order = ['f1'], axis = 0).view(np.int) #write your code here 
...
def function17():
    ...
    return np.where(np.logical_and(arr%3==0, arr%5==0), "YES", "NO")          # Write Your Code HERE
